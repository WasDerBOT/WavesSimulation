...
class Ui_Create(object):
    def setupUi(self, Create):
        ...
        self.Create_2 = QtWidgets.QPushButton(parent=Create)
        self.Create_2.setGeometry(QtCore.QRect(150, 510, 291, 61))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.Create_2.setFont(font)
        self.Create_2.setObjectName("Create_2")
        self.Create_3 = QtWidgets.QPushButton(parent=Create)
        self.Create_3.setGeometry(QtCore.QRect(600, 510, 151, 61))
        font = QtGui.QFont()
        font.setPointSize(22)
    ...
    def retranslateUi(self, Create):
        ...
        self.Create_2.setText(_translate("Create", "Create"))
        self.Create_3.setText(_translate("Create", "Go back"))
